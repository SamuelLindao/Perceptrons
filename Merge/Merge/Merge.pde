  ...
  while(index < imagePaths.length)
  {
    ...
    for(int i =0 ; i < img1.width;i++)
    {
      for(int j = 0 ; j < img1.height;j++)
      {
        ...
        if(dist(red(c1),green(c1),blue(c1),red(c2),green(c2),blue(c2)) > 128)
         {
    ...
    img1.save("C:\\Users\\lacer\\OneDrive\\Desktop\\Merge\\image" + index +".png");
    img2.save("C:\\Users\\lacer\\OneDrive\\Desktop\\Merge\\image" + (index + 1)+".png");
    index += 2;
  } else {
